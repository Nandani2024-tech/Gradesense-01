import re
path = r'e:\SSB -2\NF\Gradesense-01\GradeSense1-main\backend\app\services\pipelines\ai_structured_engine.py'
...
if modified:
    with open(path, 'w', encoding='utf-8') as f:
        f.write(code)
    print('Updated ai_structured_engine.py successfully')
else:
    print('No changes needed for ai_structured_engine.py')
