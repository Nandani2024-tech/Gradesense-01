...
norm_sub_label = _norm_sub_label
key = _key
evidence = _evidence
extract_mark_value = _extract_mark_value
parse_sub_label = _parse_sub_label
question_number_from_line = _question_number_from_line
collect_ocr_lines = _collect_ocr_lines
detect_header_total = _detect_header_total
parse_section_math = _parse_section_math
extract_instruction_mark = _extract_instruction_mark
find_question_anchors = _find_question_anchors
find_right_margin_mark_candidates = _find_right_margin_mark_candidates
detect_visual_or_groups = _detect_visual_or_groups
has_or_signal = _has_or_signal
split_contiguous_runs = _split_contiguous_runs
canonicalize_or_group_ids = _canonicalize_or_group_ids
compute_effective_total = _compute_effective_total
__all__ = [
    "norm_sub_label",
    "key",
    "evidence",
    ...
    "detect_header_total",
    "parse_section_math",
    "extract_instruction_mark",
    "find_question_anchors",
    "find_right_margin_mark_candidates",
    "detect_visual_or_groups",
    "has_or_signal",
    "split_contiguous_runs",
    "canonicalize_or_group_ids",
    "compute_effective_total",
    "resolve_visual_marks",
]
