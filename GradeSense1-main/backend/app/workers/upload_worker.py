...
async def process_model_answer_background(exam_id: str) -> None:
    ...
    """
    try:
        from app.services.extraction.background_tasks import _process_model_answer_async
...
async def process_question_paper_background(exam_id: str) -> None:
    ...
    """
    try:
        from app.services.extraction.background_tasks import _process_question_paper_async
