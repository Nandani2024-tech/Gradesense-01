...
def build_extraction_prompt(
    *,
    ...
    rules = [
        ...
        "CRITICAL MARK EXTRACTION RULES:",
        "1. Extract marks for each question if explicitly present in the text (e.g., [2], (5), '2 marks', '5M').",
        "2. If marks are clearly visible, assign them.",
        "3. If marks are NOT visible, set marks = null (NOT 0).",
        "4. Do NOT hallucinate marks.",
        "5. Each question must independently contain marks if available.",
